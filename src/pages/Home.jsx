        ...
        <Container>
          <Row className="align-items-center">
            <Col md="8">
              ...
              <p className="text">
                Don't miss out on exclusive deals and unforgettable experiences.
                Contact us to plan your perfect getaway.Start your adventure
                with us today—book your dream trip now!,{" "}
              </p>
            </Col>
